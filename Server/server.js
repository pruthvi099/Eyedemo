...
// Delete a customer
app.delete('/bcustomers/:customer_id', (req, res) => {
...
app.get('/dproducts/:product_id', (req, res) => {
...
app.get('/wdetails/:sale_id', (req, res) => {
...
app.get('/wadetails/:purchase_id', (req, res) => {
