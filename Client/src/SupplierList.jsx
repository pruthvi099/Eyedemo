...
const SupplierList = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:3000/csuppliers')
            .then(result => {
                if (result.data) {
    ...
    const filterSuppliers = (suppliers, query) => {
        ...
        return suppliers.filter(supplier => 
            ...
            supplier.phone_number.toLowerCase().includes(normalizedQuery)
        );
    };
    ...
    return (
        <div id='supplierbody'>
            <div className="supplier-container">
                <Link to="/addsupplier" className="add-supplier-link">Add Supplier</Link>
